...
const sectionDescription = "Being a new cryptocurrency, Quillon offers a low barrier for entry. Join our network today and become one of the first to take advantage of our revolutionary monetary policy. You can trade, hold and earn our currency via the links below";
  ...
  render() {
    return (
      <Element name="network-section" className="network-section">
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <div className="row hover12">
                <div className="d-block mx-auto">
                  <figure>
                    <img className="bottom trade-subImage" src={tradesatoshiBadge} role="presentation"/>
                    <img className="top trade-subImage" src={tradesatoshiBadgeHover} role="presentation"/>
                  </figure>
                </div>
              </div>
              <div className="row hover12">
                <div className="d-block mx-auto">
                  <figure>
                    <img className="bottom trade-subImage" src={cryptoPia} role="presentation"/>
                    <img className="top trade-subImage" src={cryptoPiaHover} role="presentation"/>
                  </figure>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              ...
              <div className="row hover12">
                <div className="d-block mx-auto">
                  <figure>
                    <img className="bottom earn-subImage" src={miningPool} role="presentation"/>
                    <img className="top earn-subImage" src={miningPoolHover} role="presentation"/>
                  </figure>
                </div>
              </div>
              <div className="row hover12">
                <div className="d-block mx-auto">
                  <figure>
                    <img className="bottom earn-subImage" src={masterNode} role="presentation"/>
                    <img className="top earn-subImage" src={masterNodeHover} role="presentation"/>
                  </figure>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              ...
              <div className="row pl-3 pr-3 hold-subImage">
                <div className="col-3 hover12 ml-auto">
                  <div className="d-block">
                    <figure>
                      <img className="bottom" src={windows} role="presentation"/>
                      <img className="top" src={windowsHover} role="presentation"/>
                    </figure>
                  </div>
                </div>
                <div className="col-3 hover12 mx-auto">
                  <div className="d-block">
                    <figure>
                      ...
                      <img className="top" src={appleHover} role="presentation"/>
                    </figure>
                  </div>
                </div>
                <div className="col-3 hover12 mr-auto">
                  <div className="d-block">
                    <figure>
                      <img className="bottom" src={ubuntu} role="presentation"/>
                      <img className="top" src={ubuntuHover} role="presentation"/>
                    </figure>
                  </div>
                </div>
              </div>
              <div className="row chooseWallet-image">
                <div className="d-block mx-auto">
                  <figure>
                    <img className="bottom" src={chooseWallet} role="presentation"/>
                  </figure>
                </div>
              </div>
            </div>
        ...
        <img src={ellipseDecorateH} className="ellipseDecorateH" role="presentation"/>
        <img src={ellipseDecorateV} className="ellipseDecorateV" role="presentation"/>
      </Element>
    )
  }
}
